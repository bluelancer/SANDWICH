...
template = """#!/bin/bash
#SBATCH -J train_baseline_{env_family}
#SBATCH -n 1
#SBATCH --mem=16G
#SBATCH -t --cpus-per-task=32
#SBATCH -t 6:29:59
#SBATCH --mail-type=ALL
#SBATCH --mail-user=yifeij@kth.se
#SBATCH -o ./train_baseline_{env_family}.out
#SBATCH -e ./train_baseline_{env_family}.err
...
python train_baselines_duo.py --env_index 
...
output_dir = 'gen_baseline_parallel_scripts'
