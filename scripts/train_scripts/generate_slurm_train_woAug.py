...
template = """#!/bin/bash
#SBATCH -J train_dt_winert_across_rx_wonoise_wotype_thin_long_{env_id}
#SBATCH -n 1
#SBATCH -C "thin"
#SBATCH --gpus 1
#SBATCH -t 3:30:59
...
#SBATCH -o ./train_dt_winert_across_rx_wonoise_wotype_thin_long_{env_id}.out
#SBATCH -e ./train_dt_winert_across_rx_wonoise_wotype_thin_long_{env_id}.err
...
python train_dt.py --allTx True --wandb True --env_index {env_id} --add_type_loss False
echo "Finished concurrent execution of tasks."
echo "Ending time: $(date)"
"""

# Create directory for the SLURM scripts if it does not exist
output_dir = 'gen_train_scripts_woAug_wotype'
