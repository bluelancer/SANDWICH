...
# no_env_ids = [9,10,13,18,29,31,32,33,45,47,48,49,59,67,71,72,77,88,90,92,93,94,99, 105, 109, 114,116,119,120,121,122,123,124,130]
template = """#!/bin/bash
#SBATCH -J train_dt_winert_wnoise_thin_long_{env_id}
#SBATCH -n 1
#SBATCH -C "thin"
#SBATCH --gpus 1
#SBATCH -t 12:30:59
...
#SBATCH -o ./train_dt_winert_across_rx_wnoise_thin_long_{env_id}.out
#SBATCH -e ./train_dt_winert_across_rx_wnoise_thin_long_{env_id}.err
...
python train_dt.py --allTx True --wandb True --add_noise True --noise_sample 5 --env_index {env_id}
echo "Finished concurrent execution of tasks."
echo "Ending time: $(date)"
"""

# Create directory for the SLURM scripts if it does not exist
output_dir = 'gen_train_scripts'
