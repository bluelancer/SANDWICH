...
#SBATCH -o ./test_dt_wonoise_long{env_id}_full.out
#SBATCH -e ./test_dt_wonoise_long{env_id}_full.err
...
python test_dt.py --allTx True --env_index {env_id} --eval_from latest --test_data test
python test_dt.py --allTx True --env_index {env_id} --eval_from latest --test_data genz
python test_dt.py --allTx True --env_index {env_id} --eval_from latest --test_data gendiag

"""

# Create directory for the SLURM scripts if it does not exist
output_dir = 'gen_test_scripts_wonoise'
