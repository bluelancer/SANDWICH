...
#SBATCH -o /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/ppall_less_scene9.out
#SBATCH -e /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/ppall_less_scene9.err
...
python preprocessing_dt.py --env_index 9 --allTx True --Ofunc True --add_noise True --noise_sample 5
