#!/bin/bash
#SBATCH -J ppalltest10
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -t 8:59:59
#SBATCH --mail-type=ALL
#SBATCH --mail-user=yifeij@kth.se
#SBATCH -o /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/prev_logs_test/ppall_test_scene10.out
#SBATCH -e /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/prev_logs_test/ppall_test_scene10.err
...
python preprocessing_dt.py --env_index 10 --allTx True --Ofunc True --test_pp True
