...
#SBATCH -o /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/prev_logs_test/ppall_test_scene1.out
#SBATCH -e /proj/raygnn/workspace/WINeRT/GFlowNet/torchgfn/tutorials/notebooks/scripts/slurm_pp_less_repo/prev_logs_test/ppall_test_scene1.err
...
python preprocessing_dt.py --env_index 1 --allTx True --Ofunc True --test_pp True
