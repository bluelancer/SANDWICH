...
template = """#!/bin/bash
#SBATCH -J hpsearch_amend_test_{env_id}
#SBATCH -n 1
#SBATCH -C "thin"
#SBATCH --gpus 1
#SBATCH -t 00:59:59
...
#SBATCH -o ./hpsearch_amend_test_{env_id}.out
#SBATCH -e ./hpsearch_amend_test_{env_id}.err
