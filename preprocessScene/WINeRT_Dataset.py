...
class WINeRT_Dataset(Dataset):
    ...
    def __init__(self, hdf5_repo_path, type = "train"):
        ...
        if type == "test" or type == "train":
            test_postfix = ("checkerboard-dataset_0.h5", "checkerboard-dataset_1.h5")
        elif type == "genz":
            test_postfix = ("genz-dataset_0.h5", "genz-dataset_1.h5")
        elif type == "gendiag":
            test_postfix = ("gendiag-dataset_0.h5", "gendiag-dataset_1.h5")
        else:
        ...
        for path in self.hdf5_dir_list:
            ...
            elif path.endswith(test_postfix):
                self.test_hdf5_dir_list.append(path)
            else:
                pass
        ...
        elif self.type == "test" or self.type == "genz" or self.type == "gendiag":
