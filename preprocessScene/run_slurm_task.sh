#!/bin/bash
#SBATCH --job-name=winert_preprocess       # Set a name for your job
...
#SBATCH --output=winert_pp.out     # Define the name of the output log file
#SBATCH --error=winert_pp.err       # Define the name of the error log file
...
# Run your script
python preprocessing_torch_cuda.py
